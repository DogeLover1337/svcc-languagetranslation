...
app.get('/translate', function(req, res) {
  ...
  if(service && service.username && service.password) {
    ...
    language_translator.translate({
      text: 'Hello Silicon Valley Code Camp!', source: 'en', target: 'fr'
      ...
      if(err) {
        ...
        // Uncomment
        //request.post('https://svcctracker.mybluemix.net/check/svcclang', {form: submission}, function(err, response, body) {
        //  res.send(body);
        //});
      }
    });
